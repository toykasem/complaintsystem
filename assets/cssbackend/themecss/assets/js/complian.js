(function (global, factory) {
	...
	const echartSetOption = (e, t, o, r) => {
		const { breakpoints: a, resize: n } = window.complian.utils,
			s = (t) => {
		...
		c &&
			...
			i.addEventListener("clickControl", ({ detail: { control: r } }) => {
				"complianTheme" === r && e.setOption(window._.merge(o(), t));
			});
	};
	...
	const basicEchartsInit = () => {
		const { getColor: t, getData: o, getDates: e } = window.complian.utils;
	...
	const reportsDetailsChartInit = () => {
		const { getColor: t, getData: o, toggleColor: e } = window.complian.utils,
	...
	const copyLink = () => {
		const { getData: t } = window.complian.utils;
	...
	const countupInit = () => {
		const { getData: o } = window.complian.utils;
		if (window.countUp) {
	...
	const detectorInit = () => {
		const { addClass: e } = window.complian.utils,
			{ is: o } = window,
		...
		if (l.length && window.google) {
			...
			l.forEach((l) => {
				const o = e(l, "latlng").split(","),
					...
					y = l,
					n = e(l, "complianTheme");
				if ("streetview" === e(l, "complianTheme")) {
					const t = e(l, "pov"),
						i = {
				...
				const p = {
						...
						styles:
							"dark" === window.config.config.complianTheme
								? s.SnazzyCustomDark
	...
	const modalInit = () => {
		const o = document.querySelectorAll("[data-complian-modal]");
		o &&
			o.forEach((o) => {
	...
	const handleNavbarVerticalCollapsed = () => {
		const {
			...
			b = e("complianIsNavbarVerticalCollapsed", !1);
		v &&
			v.addEventListener(i, (e) => {
				v.blur(),
					document.documentElement.classList.toggle(d),
					t("complianIsNavbarVerticalCollapsed", !b);
	...
	const complianOffcanvasInit = () => {
		const { getData: e } = window.complian.utils,
			o = document.querySelectorAll("[data-complian-toggle='offcanvas']"),
			t = document.querySelector("[data-complian-backdrop]"),
			a = document.querySelector("[data-complian-scroll]"),
		...
		o &&
			o.forEach((o) => {
				const c = e(o, "complian-target"),
					n = document.querySelector(c),
					d = n.querySelectorAll("[data-complian-dismiss='offcanvas']");
				o.addEventListener("click", () => {
	...
	const getThubmnailDirection = () =>
			...
			(window.innerWidth >= 992 && window.innerWidth < 1200)
				...
				: "vertical",
		productDetailsInit = () => {
			const { getData: e, resize: t } = window.complian.utils,
	...
	const ratingInit = () => {
		const { getData: t, getItemFromStore: e } = window.complian.utils;
		document.querySelectorAll("[data-rater]").forEach((r) => {
			const a = {
				reverse: e("complianIsRTL"),
				starSize: 32,
				step: 0.5,
				element: r,
				rateCallback(t, e) {
	...
	const responsiveNavItemsInit = () => {
		const { resize: e } = window.complian.utils,
			t = "[data-nav-item]",
			l = "[data-navbar]",
			o = "[data-more-item]",
	...
	const supportChatInit = () => {
		const t = document.querySelector(".support-chat"),
			...
			{ complianSupportChat: s } = window.config.config;
	...
	const { config: config } = window.config,
			...
			e &&
				e.querySelectorAll("[data-theme-control]").forEach((e) => {
					const n = t(e, "theme-control"),
						r = a(n);
					"complianNavbarTopShape" === n &&
						"dual-nav" === a("complianNavbarPosition") &&
						e.setAttribute("disabled", !0);
					const i = a("complianNavbarPosition");
					if (
						("complianNavbarVerticalStyle" === n &&
					...
					else if ("radio" === e.type && "complianNavbarVerticalStyle" === n)
						"darker" === r &&
							"darker" === e.value &&
							e.setAttribute("checked", !0),
							"default" === r &&
								"default" === e.value &&
								e.setAttribute("checked", !0);
					else if ("radio" === e.type && "complianNavbarTopShape" === n)
						"slim" === r && "slim" === e.value && e.setAttribute("checked", !0),
							"default" === r &&
								"default" === e.value &&
								e.setAttribute("checked", !0);
					else if ("radio" === e.type && "complianNavbarTopStyle" === n)
						"darker" === r &&
							"darker" === e.value &&
							e.setAttribute("checked", !0),
							"default" === r &&
								"default" === e.value &&
								e.setAttribute("checked", !0);
					else if ("radio" === e.type && "complianTheme" === n) {
						r === e.value && e.setAttribute("checked", !0);
					} else if ("radio" === e.type && "complianNavbarPosition" === n) {
						r === e.value && e.setAttribute("checked", !0);
					} else {
		...
		changeTheme = (e) => {
			...
			e.querySelectorAll('[data-theme-control = "complianTheme"]').forEach(
				(e) => {
					const n = t(e, "theme-control"),
						r = a(n);
					"checkbox" === e.type
	...
	handleThemeDropdownIcon(localStorage.getItem("complianTheme"));
	const themeControl = () => {
		const {
				getData: e,
				getItemFromStore: t,
		...
		initialDomSetup(n.node),
			n.on("click", (e) => {
				...
				if (d.data("theme-control")) {
					...
					switch (
						...
						case "complianNavbarVerticalStyle":
							r.setAttribute("data-navbar-appearance", "default"),
								"default" !== h &&
									r.setAttribute("data-navbar-appearance", "darker");
							break;
						case "complianNavbarTopStyle":
							i.setAttribute("data-navbar-appearance", "default"),
								"default" !== h &&
									i.setAttribute("data-navbar-appearance", "darker");
							break;
						case "complianNavbarTopShape":
							"dual-nav" === t("complianNavbarPosition")
								? el.setAttribute("disabled", !0)
								: o(d.node);
							break;
						case "complianNavbarPosition":
							o(d.node);
							break;
						case "complianIsRTL":
							window.config.set({ complianIsRTL: d.node.checked }),
								window.location.reload();
							break;
						case "complianSupportChat":
			...
			n.on("clickControl", ({ detail: { control: e, value: t } }) => {
				"complianTheme" === e && handleThemeDropdownIcon(t);
			});
	};
						...
						r = merge(
							{
								...
								directionality: n("complianIsRTL") ? "rtl" : "ltr",
								toolbar: [
	...
	(window.initMap = initMap),
		...
		docReady(complianOffcanvasInit),
	...
	var complian = { utils: utils, BulkSelect: BulkSelect };
