                  ...
                  <div class="card h-100">
                    <div class="card-body">
                      <div class="d-flex justify-content-between">
                        <div>
                          <h5 class="mb-1">Total orders<span class="badge badge-complian badge-complian-warning rounded-pill fs-9 ms-2"><span class="badge-label">-6.8%</span></span></h5>
                ...
                <div class="col-12 col-md-6">
                  <div class="card h-100">
                    <div class="card-body">
                      <div class="d-flex justify-content-between">
                        <div>
                          <h5 class="mb-1">New customers<span class="badge badge-complian badge-complian-warning rounded-pill fs-9 ms-2"> <span class="badge-label">+26.5%</span></span></h5>
                          <h6 class="text-body-tertiary">Last 7 days</h6>
                        </div>
                        <h4>356</h4>
                      </div>
            ...
            <div class="row align-items-end justify-content-between pb-5 g-3">
              ...
              <div class="col-12 col-md-auto">
                <div class="row g-2 gy-3">
                  ...
                  <div class="col-auto"><button class="btn btn-sm btn-complian-secondary bg-body-emphasis bg-body-hover me-2" type="button">All products</button><button class="btn btn-sm btn-complian-secondary bg-body-emphasis bg-body-hover action-btn" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h" data-fa-transform="shrink-2"></span></button>
              ...
              <table class="table fs-9 mb-0 border-top border-translucent">
                ...
                <tbody class="list" id="table-latest-review-body">
                  <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                    ...
                    <td class="align-middle product white-space-nowrap py-0"><a class="d-block rounded-2 border border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="<?php echo base_url(); ?>assets/cssbackend/themecss/assets/img/products/60x60/1.png" alt="" width="53" /></a></td>
                    ...
                    <td class="align-middle text-start ps-5 status"><span class="badge badge-complian fs-10 badge-complian-success"><span class="badge-label">Approved</span><span class="ms-1" data-feather="check" style="height:12.8px;width:12.8px;"></span></span></td>
                    ...
                    <td class="align-middle white-space-nowrap text-end pe-0">
                      <div class="position-relative">
                        <div class="hover-actions"><button class="btn btn-sm btn-complian-secondary me-1 fs-10"><span class="fas fa-check"></span></button><button class="btn btn-sm btn-complian-secondary fs-10"><span class="fas fa-trash"></span></button></div>
                      </div>
                  ...
                  <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                    ...
                    <td class="align-middle product white-space-nowrap py-0"><a class="d-block rounded-2 border border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="<?php echo base_url(); ?>assets/cssbackend/themecss/assets/img/products/60x60/2.png" alt="" width="53" /></a></td>
                    ...
                    <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center text-body" href="apps/e-commerce/landing/profile.html">
                        <div class="avatar avatar-l"><img class="rounded-circle" src="<?php echo base_url(); ?>assets/cssbackend/themecss/assets/img/team/40x40/59.webp" alt="" /></div>
                  ...
                  <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                    ...
                    <td class="align-middle product white-space-nowrap py-0"><a class="d-block rounded-2 border border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="<?php echo base_url(); ?>assets/cssbackend/themecss/assets/img/products/60x60/3.png" alt="" width="53" /></a></td>
                    ...
                    <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center text-body" href="apps/e-commerce/landing/profile.html">
                        <div class="avatar avatar-l"><img class="rounded-circle" src="<?php echo base_url(); ?>assets/cssbackend/themecss/assets/img/team/40x40/58.webp" alt="" /></div>
                    ...
                    <td class="align-middle text-start ps-5 status"><span class="badge badge-complian fs-10 badge-complian-warning"><span class="badge-label">Pending</span><span class="ms-1" data-feather="clock" style="height:12.8px;width:12.8px;"></span></span></td>
                    <td class="align-middle text-end time white-space-nowrap">
                      <div class="hover-hide">
                        <h6 class="text-body-highlight mb-0">Just now</h6>
                      </div>
                  ...
                  <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                    ...
                    <td class="align-middle product white-space-nowrap py-0"><a class="d-block rounded-2 border border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="<?php echo base_url(); ?>assets/cssbackend/themecss/assets/img/products/60x60/4.png" alt="" width="53" /></a></td>
                    ...
                    <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center text-body" href="apps/e-commerce/landing/profile.html">
                        <div class="avatar avatar-l"><img class="rounded-circle avatar-placeholder" src="<?php echo base_url(); ?>assets/cssbackend/themecss/assets/img/team/40x40/avatar.webp" alt="" /></div>
                  ...
                  <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                    ...
                    <td class="align-middle product white-space-nowrap py-0"><a class="d-block rounded-2 border border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="<?php echo base_url(); ?>assets/cssbackend/themecss/assets/img/products/60x60/5.png" alt="" width="53" /></a></td>
                  ...
                  <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                    ...
                    <td class="align-middle product white-space-nowrap py-0"><a class="d-block rounded-2 border border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="<?php echo base_url(); ?>assets/cssbackend/themecss/assets/img/products/60x60/6.png" alt="" width="53" /></a></td>
                    ...
                    <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center text-body" href="apps/e-commerce/landing/profile.html">
                        <div class="avatar avatar-l"><img class="rounded-circle" src="<?php echo base_url(); ?>assets/cssbackend/themecss/assets/img/team/40x40/57.webp" alt="" /></div>
                  ...
                  <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                    ...
                    <td class="align-middle product white-space-nowrap py-0"><a class="d-block rounded-2 border border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="<?php echo base_url(); ?>assets/cssbackend/themecss/assets/img/products/60x60/7.png" alt="" width="53" /></a></td>
                    ...
                    <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center text-body" href="apps/e-commerce/landing/profile.html">
                        <div class="avatar avatar-l"><img class="rounded-circle" src="<?php echo base_url(); ?>assets/cssbackend/themecss/assets/img/team/40x40/3.webp" alt="" /></div>
                  ...
                  <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                    ...
                    <td class="align-middle product white-space-nowrap py-0"><a class="d-block rounded-2 border border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="<?php echo base_url(); ?>assets/cssbackend/themecss/assets/img/products/60x60/8.png" alt="" width="53" /></a></td>
                    ...
                    <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center text-body" href="apps/e-commerce/landing/profile.html">
                        <div class="avatar avatar-l"><img class="rounded-circle" src="<?php echo base_url(); ?>assets/cssbackend/themecss/assets/img/team/40x40/26.webp" alt="" /></div>
                  ...
                  <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                    ...
                    <td class="align-middle product white-space-nowrap py-0"><a class="d-block rounded-2 border border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="<?php echo base_url(); ?>assets/cssbackend/themecss/assets/img/products/60x60/9.png" alt="" width="53" /></a></td>
                    ...
                    <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center text-body" href="apps/e-commerce/landing/profile.html">
                        <div class="avatar avatar-l"><img class="rounded-circle" src="<?php echo base_url(); ?>assets/cssbackend/themecss/assets/img/team/40x40/29.webp" alt="" /></div>
                  ...
                  <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                    ...
                    <td class="align-middle product white-space-nowrap py-0"><a class="d-block rounded-2 border border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="<?php echo base_url(); ?>assets/cssbackend/themecss/assets/img/products/60x60/10.png" alt="" width="53" /></a></td>
                  ...
                  <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                    ...
                    <td class="align-middle product white-space-nowrap py-0"><a class="d-block rounded-2 border border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="<?php echo base_url(); ?>assets/cssbackend/themecss/assets/img/products/60x60/11.png" alt="" width="53" /></a></td>
                    ...
                    <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center text-body" href="apps/e-commerce/landing/profile.html">
                        <div class="avatar avatar-l"><img class="rounded-circle" src="<?php echo base_url(); ?>assets/cssbackend/themecss/assets/img/team/40x40/8.webp" alt="" /></div>
                  ...
                  <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                    ...
                    <td class="align-middle product white-space-nowrap py-0"><a class="d-block rounded-2 border border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="<?php echo base_url(); ?>assets/cssbackend/themecss/assets/img/products/60x60/12.png" alt="" width="53" /></a></td>
                  ...
                  <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                    ...
                    <td class="align-middle product white-space-nowrap py-0"><a class="d-block rounded-2 border border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="<?php echo base_url(); ?>assets/cssbackend/themecss/assets/img/products/60x60/13.png" alt="" width="53" /></a></td>
                    ...
                    <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center text-body" href="apps/e-commerce/landing/profile.html">
                        <div class="avatar avatar-l"><img class="rounded-circle" src="<?php echo base_url(); ?>assets/cssbackend/themecss/assets/img/team/40x40/9.webp" alt="" /></div>
                  ...
                  <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                    ...
                    <td class="align-middle product white-space-nowrap py-0"><a class="d-block rounded-2 border border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="<?php echo base_url(); ?>assets/cssbackend/themecss/assets/img/products/60x60/14.png" alt="" width="53" /></a></td>
                  ...
                  <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                    ...
                    <td class="align-middle product white-space-nowrap py-0"><a class="d-block rounded-2 border border-translucent" href="apps/e-commerce/landing/product-details.html"><img src="<?php echo base_url(); ?>assets/cssbackend/themecss/assets/img/products/60x60/15.png" alt="" width="53" /></a></td>
                    ...
                    <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center text-body" href="apps/e-commerce/landing/profile.html">
                        <div class="avatar avatar-l"><img class="rounded-circle" src="<?php echo base_url(); ?>assets/cssbackend/themecss/assets/img/team/40x40/24.webp" alt="" /></div>
                      ...
                      <td class="white-space-nowrap ps-0 country" style="width:32%">
                        <div class="d-flex align-items-center">
                          <h6 class="mb-0 me-3">1. </h6><a href="#!">
                            <div class="d-flex align-items-center"><img src="<?php echo base_url(); ?>assets/cssbackend/themecss/assets/img/country/india.png" alt="" width="24" />
                      ...
                      <td class="white-space-nowrap ps-0 country" style="width:32%">
                        <div class="d-flex align-items-center">
                          <h6 class="mb-0 me-3">2. </h6><a href="#!">
                            <div class="d-flex align-items-center"><img src="<?php echo base_url(); ?>assets/cssbackend/themecss/assets/img/country/china.png" alt="" width="24" />
                      ...
                      <td class="white-space-nowrap ps-0 country" style="width:32%">
                        <div class="d-flex align-items-center">
                          <h6 class="mb-0 me-3">3. </h6><a href="#!">
                            <div class="d-flex align-items-center"><img src="<?php echo base_url(); ?>assets/cssbackend/themecss/assets/img/country/usa.png" alt="" width="24" />
                      ...
                      <td class="white-space-nowrap ps-0 country" style="width:32%">
                        <div class="d-flex align-items-center">
                          <h6 class="mb-0 me-3">4. </h6><a href="#!">
                            <div class="d-flex align-items-center"><img src="<?php echo base_url(); ?>assets/cssbackend/themecss/assets/img/country/south-korea.png" alt="" width="24" />
                      ...
                      <td class="white-space-nowrap ps-0 country" style="width:32%">
                        <div class="d-flex align-items-center">
                          <h6 class="mb-0 me-3">5. </h6><a href="#!">
                            <div class="d-flex align-items-center"><img src="<?php echo base_url(); ?>assets/cssbackend/themecss/assets/img/country/vietnam.png" alt="" width="24" />
                      ...
                      <td class="white-space-nowrap ps-0 country" style="width:32%">
                        <div class="d-flex align-items-center">
                          <h6 class="mb-0 me-3">6. </h6><a href="#!">
                            <div class="d-flex align-items-center"><img src="<?php echo base_url(); ?>assets/cssbackend/themecss/assets/img/country/russia.png" alt="" width="24" />
                      ...
                      <td class="white-space-nowrap ps-0 country" style="width:32%">
                        <div class="d-flex align-items-center">
                          <h6 class="mb-0 me-3">7. </h6><a href="#!">
                            <div class="d-flex align-items-center"><img src="<?php echo base_url(); ?>assets/cssbackend/themecss/assets/img/country/australia.png" alt="" width="24" />
                      ...
                      <td class="white-space-nowrap ps-0 country" style="width:32%">
                        <div class="d-flex align-items-center">
                          <h6 class="mb-0 me-3">8. </h6><a href="#!">
                            <div class="d-flex align-items-center"><img src="<?php echo base_url(); ?>assets/cssbackend/themecss/assets/img/country/england.png" alt="" width="24" />
                      ...
                      <td class="white-space-nowrap ps-0 country" style="width:32%">
                        <div class="d-flex align-items-center">
                          <h6 class="mb-0 me-3">9. </h6><a href="#!">
                            <div class="d-flex align-items-center"><img src="<?php echo base_url(); ?>assets/cssbackend/themecss/assets/img/country/indonesia.png" alt="" width="24" />
                      ...
                      <td class="white-space-nowrap ps-0 country" style="width:32%">
                        <div class="d-flex align-items-center">
                          <h6 class="mb-0 me-3">10. </h6><a href="#!">
                            <div class="d-flex align-items-center"><img src="<?php echo base_url(); ?>assets/cssbackend/themecss/assets/img/country/japan.png" alt="" width="24" />
