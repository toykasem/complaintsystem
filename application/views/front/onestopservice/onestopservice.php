...
background: radial-gradient(circle, rgba(169,157,230,1) 0%, rgba(175,178,213,1) 46%, rgba(124,139,223,1) 100%);box-shadow: rgb(38, 57, 77) 0px 20px 30px -10px;">
                                <div class="card-body" style="height:150px">
                                    ...
                                    <h4 class="card-text font_view">แจ้งคำร้องร้องเรียน</h4>
                                </div>
                            </div>
                        </a>
                    </div>
...
background: radial-gradient(circle, rgba(169,157,230,1) 0%, rgba(175,178,213,1) 46%, rgba(124,139,223,1) 100%);box-shadow: rgb(38, 57, 77) 0px 20px 30px -10px;">
                                <div class="card-body" style="height:150px">
                                    ...
                                    <h4 class="card-text font_view">ตรวจสอบ<br />ผลดำเนินการ</h4>
                                </div>
                            </div>
                        </a>
                    </div>
...
background: radial-gradient(circle, rgba(169,157,230,1) 0%, rgba(175,178,213,1) 46%, rgba(124,139,223,1) 100%);box-shadow: rgb(38, 57, 77) 0px 20px 30px -10px;">
                                <div class="card-body" style="height:150px">
                                    ...
                                    <h4 class="card-text font_view">ประเมินความพึงพอใจ<br />ในการบริการ</h4>
                                </div>
                            </div>
                        </a>
                    </div>
